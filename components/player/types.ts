...
/** 播放器窗口形态：window 浮窗 / mini 小窗 / fab 圆钮 / fullscreen 独占全屏 */
export const PLAYER_DISPLAY_MODES = ['window', 'mini', 'fab', 'fullscreen'] as const;
...
export type PlayerAction =
  ...
  /** 形态切换：window/mini/fab 互转自由；fullscreen 同样接受（宿主 effect 负责真实全屏 API），非法值由 reducer 拒绝 */
