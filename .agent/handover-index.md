...
> generated_at: 2026-07-28T22:32:49+08:00
...
| search-contract-production-fix | waiting | 2026-07-28T22:32:49+08:00 | in_progress | ["Luvia-Gallery", "frontend", "backend", "search"] | 搜索范围统一与残留查询故障修复待验证 | `.agent/handover.md` · `2026-07-28T22:32:49+08:00` · `fp:c85d1645ba` |
...
| 2026-07-23T22:07:00+08:00 | iso | done | resume | macos-widget/lock-settings-polish | [macos, position-lock, regression, settings-ui, grid-snap] | 悬浮窗锁定回归修复 + 设置文案/网格范围调整 | `.agent/handover.md` · `2026-07-23T22:07:00+08:00` · `fp:1a9e4b73f1` |
| 2026-07-23T21:12:00+08:00 | iso | done | resume | macos-widget/loading-network | [correction, loading, urlsession, tailscale, window-level] | 修正：UDP QoS 推论推翻 + 加载转圈/失败根因实为 App 实现 + 启动层级修复 | `.agent/handover.md` · `2026-07-23T21:12:00+08:00` · `fp:130fa8d362` |
| 2026-07-23T17:20:00+08:00 | iso | monitoring | resume | network/fnos-tailscale-qos | [network, tailscale, udp-qos, cgnat, qbittorrent, pt, pcdn] | Tailscale 慢速根因排查：运营商 UDP QoS（PT 触发） | `.agent/handover.md` · `2026-07-23T17:20:00+08:00` · `fp:26d59f2f20` |
| 2026-07-23T14:35:00+08:00 | iso | done | resume | full-stack/media-filter-deeplink-deploy | [macos, media-filter, deep-link, frontend, fnos-deploy, packaging] | 媒体过滤 + 网页深链 + FNOS 部署 + 打包流程固化 | `.agent/handover.md` · `2026-07-23T14:35:00+08:00` · `fp:8022ecc4f2` |
| 2026-07-23T13:42:00+08:00 | iso | done | close | macos-widget/icon-install | [macos, app-icon, packaging, install, delivery] | 悬浮窗 App 图标接入与 /Applications 安装交付（收官） | `.agent/handover.md` · `2026-07-23T13:42:00+08:00` · `fp:97c2b1a205` |
